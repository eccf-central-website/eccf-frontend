 ...
 * Provides embedded modal playback (YouTube & Spotify) plus clean platform direct links.
 */
              ...
              return (
                ...
                >
                  <div>
                    ...
                    <div className="relative h-40 sm:h-48 w-full bg-slate-900 overflow-hidden flex items-center justify-center">
                      {youtubeId ? (
                        <>
                          <Image
